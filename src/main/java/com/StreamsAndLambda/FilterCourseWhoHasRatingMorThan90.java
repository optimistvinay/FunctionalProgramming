...
public class FilterCourseWhoHasRatingMorThan90 {
    ...
    public static void main(String[] args) {
        ...
        filterCourseOnRating(courseContents);

    }

    private static void filterCourseOnRating(List<CourseContent> courseContents) {

        courseContents.stream()
                .filter(courseContent -> courseContent.getRating()>90)
