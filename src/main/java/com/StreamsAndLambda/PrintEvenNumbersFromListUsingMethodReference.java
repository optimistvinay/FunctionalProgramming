...
public class PrintEvenNumbersFromListUsingMethodReference {
    ...
    private static void printEvenNumber(List<Integer> list) {
        ...
        list.stream().filter(PrintEvenNumbersFromListUsingMethodReference::isEven).forEach(System.out::println);
    }
}
